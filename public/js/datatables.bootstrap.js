    ...
    "bootstrap": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<li class="first disabled" style="display:none"><a href="#" title="' + oLang.sFirst + '">Previous</a></li>' +
                '<li class="prev disabled"><a href="#" title="' + oLang.sPrevious + '">Previous</a></li>' +
                '<li class="next disabled"><a href="#" title="' + oLang.sNext + '">Next</a></li>' +
                '<li class="last disabled" style="display:none"><a href="#" title="' + oLang.sLast + '"><i class="fas fa-fast-forward"></i></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
